...
// (svgChildrenOfMale, svgChildrenOfFemale)
  ...
  svgChildrenOfMale:
    <svg className='connect-children-male' key='c-cm' width='560' height='120'>
      <line x1='80' y1='40' x2='80' y2='80' stroke='#333333' strokeWidth='5' />
      <line x1='480' y1='0' x2='480' y2='80' stroke='#333333' strokeWidth='5' />
      <line x1='80' y1='80' x2='480' y2='80' stroke='#333333' strokeWidth='5' />
      <line x1='180' y1='80' x2='180' y2='120' stroke='#333333' strokeWidth='5' />
    </svg>,

  // Use svgChildrenOfFemale for female focus person.
  svgChildrenOfFemale:
    <svg className='connect-children-female' key='c-cf' width='560' height='120'>
      <line x1='80' y1='0' x2='80' y2='80' stroke='#333333' strokeWidth='5' />
      <line x1='480' y1='40' x2=' 480' y2='80' stroke='#333333' strokeWidth='5' />
      <line x1='80' y1='80' x2='480' y2='80' stroke='#333333' strokeWidth='5' />
      <line x1='380' y1='80' x2='380' y2='120' stroke='#333333' strokeWidth='5' />
    </svg>
};
